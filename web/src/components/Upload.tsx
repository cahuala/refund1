...
export function Upload({ filename=null,...rest}: Props){
    return <div>
        ...
        <label htmlFor="upload" className="flex h-12 px-4 items-center bg-green-100 rounded-lg px-4 cursor-pointer disabled:opacity-50 hover:bg-green-200 transition ease-linear">
